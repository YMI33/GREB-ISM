#!/bin/csh
# job script for running scenario experiment
...
#  EXP = 200 pi-control CO2= CO2_SCN
#  EXP = 205 SW-osc-20k 340ppm
#  EXP = 206 SW-osc-50k 340ppm
#  EXP = 207 SW-osc-100k 340ppm
#
#  EXP = 301 paper exp:   10m icesheet
#  EXP = 302 paper exp: 1000m topo

#  EXP = 330 experiment: transition experiment forced by CO2 and orbital forcing [250kyr]
#  EXP = 331 experiment: Eemian scenario (CO2 267.1646, YEAR -127 000) 
#  EXP = 332 experiment: LGM scenario (CO2 189.6219, YEAR -24 000) 
...
set FCO2=${IDIR}'/CO2/CO2_paleo.txt'

rm -f tclim ztopo qclim moist solar uwind vwind mldclim cloud orbit toclim abswind
rm -f omclim omstdv iceclm bedrock test.gad precip co2forcing
...
# GrADS ctl file for binary files
@ TDIM = 12 * $TIME_CTRL
...
#!/bin/csh
# restart file for experiment

# name of experiment
set CO2  = $CO2
set NAME = $NAME
 
# GREB experiment set up exp = 10 -> complete model
set EXP        = $EXP
